                ...
                <div>
                    ...
                    <form onSubmit={this._handleSubmit} className={`text-gray-600 ${this.state.success ? 'hidden' : 'block'}`}>
                        <input
                            ...
                            name="email"
                            className="rounded outline-none w-full text-black placeholder-gray-600 mr-2 py-2 px-4 pr-2 mb-4 border border-gray-400 focus-within:border-blue-600"
                        />
                        {this.state.processing
                            ?
                            <span className="inline-flex w-full px-4 py-3 text-white flex-shrink-0 bg-gray-500 transition ease-in-out duration-150 cursor-pointer rounded">
                            ...
                            :
                            <input type="submit" className="w-full px-4 py-3 text-white flex-shrink-0 cursor-pointer bg-black rounded" value="Subscribe" />
                        }
                    </form>
