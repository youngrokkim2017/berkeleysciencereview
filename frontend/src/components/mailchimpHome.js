                ...
                <div>
                    ...
                    <form onSubmit={this._handleSubmit} className={`text-gray-600 ${this.state.success ? 'hidden' : 'block'}`}>
                        ...
                        {this.state.processing
                            ?
                            <span className="inline-flex w-full px-4 py-3 leading-none text-white flex-shrink-0 bg-gray-500 transition ease-in-out duration-150 cursor-not-allowed rounded">
